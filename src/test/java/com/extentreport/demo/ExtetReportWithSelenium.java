...
public class ExtetReportWithSelenium 
{
	...
	public void setup()
	{
	    ExtentHtmlReporter reporter=new ExtentHtmlReporter("./Reports/selemiumreport.html");
	...
	public void loginTest() throws IOException
	{
		...
		Utility1.getScreenshot(driver, "google opened");
